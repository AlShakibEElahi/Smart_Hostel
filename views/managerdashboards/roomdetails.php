...
<html>
    ...
    <body>
        ...
        <tr>
            ...
            <td><a href='../../views/managerdashboards/editroom.php?rno=<?php echo $row['roomno']; ?>'> edit </a> </td>
            <td><a href='../../controllers/managersection/deleteroomValidator.php?rno=<?php echo $row['roomno']; ?>'>delete </a> </td>
        </tr>
        <?php
        }
        echo "</table>"
